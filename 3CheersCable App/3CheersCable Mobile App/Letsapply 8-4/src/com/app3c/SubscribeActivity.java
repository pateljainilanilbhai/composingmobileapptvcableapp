...
public class SubscribeActivity extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new WebServiceHitter(this).execute(GenerateURLs
				.getPostURL(Operation.CATEGORIES));
		...
		next.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				ListView lv = (ListView) subscribe_dialog
				...
				btn_cancel = (Button) subscribe_dialog
	...
	public void onClick(View arg0) {
		if (arg0 == btn_ok) {
			...
			if (confirmed.size() > 0) {
				editor.putString(MainActivity.CATEGORY_ID_LIST,
						SavedPreferencesParser.getPrefJSON(confirmedId)
								.toString());
				editor.putString(MainActivity.CATEGORY_LIST,
						SavedPreferencesParser.getPrefJSON(confirmed)
								.toString());
			} else {
			...
			this.finish();
			overridePendingTransition(R.anim.l_to_r_enter_anim,
