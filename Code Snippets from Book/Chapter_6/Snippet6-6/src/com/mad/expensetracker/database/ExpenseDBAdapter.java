package com.mad.expensetracker.database;
...
public class ExpenseDBAdapter {
	...
	private static final String DB_NAME="Expense_Database.db";
	...
	public boolean deleteExpense(long expenseId) {
		return expenseDatabase.delete(TABLE_NAME, KEY_ID+" = "+expenseId, null)>0;
	}
	
	
	public int updateExpense(long expenseId,String expense,int amount) {
		
		ContentValues updateValues=new ContentValues();
		updateValues.put(COLUMN_EXPENSE, expense);
		updateValues.put(COLUMN_AMOUNT, amount);
		return expenseDatabase.update(TABLE_NAME, updateValues, KEY_ID+" = "+expenseId, null);
	}
